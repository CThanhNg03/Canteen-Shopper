import "dotenv/config"; import { db } from "./index"; import { organizationUnits,mealTypes,tableTypes,dishes,ingredients } from "./schema";
...
async function seed(){
  ...
  await db.insert(ingredients).values(["Thịt bò","Thịt gà","Thịt vai","Cần tây","Hoa thiên lý","Lá giang","Mướp đắng","Rau muống","Mướp hương","Chuối"].map(name=>({name,unit:"kg"}))).onConflictDoNothing();
}
